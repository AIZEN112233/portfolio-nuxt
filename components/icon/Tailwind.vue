<template>
	<div
		class="relative w-fit p-2 border-#2298BD border-4 rounded-xl after:(absolute duration-400 content-[''] h-0 w-0 rounded-[100px] left-1/2 top-1/2 bg-#2298BD -z-100) after:hover:(w-full h-full top-0 left-0 rounded-md)">
		<svg
			...
			<defs>
				<linearGradient
					...
					<stop
						offset="0%"
						stopColor="#2298BD"></stop>
					<stop
						offset="100%"
						stopColor="#0ED7B5"></stop>
				</linearGradient>
			</defs>
			<path
				:fill="!hover ? '#2298BD' : '#fff'"
				class="duration-400"
