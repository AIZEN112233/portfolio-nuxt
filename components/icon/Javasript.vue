<template>
	<div
		class="relative w-fit p-2 border-#f5de19 border-4 rounded-xl after:(absolute duration-400 content-[''] h-0 w-0 rounded-[100px] left-1/2 top-1/2 bg-#f5de19 -z-100) after:hover:(w-full h-full top-0 left-0 rounded-md)">
		<svg
			...
			<path
				class="duration-400"
				:fill="!hover ? '#f5de19' : '#fff'"
				d="M2 2h28v28H2z"></path>
			<path
				:fill="!hover ? '#fff' : '#f5de19'"
