<template>
	<div
		class="relative w-fit p-2 border-#007acc border-4 rounded-xl after:(absolute duration-400 content-[''] h-0 w-0 rounded-[100px] left-1/2 top-1/2 bg-#007acc -z-100) after:hover:(w-full h-full top-0 left-0 rounded-md)">
		<svg
			...
			viewBox="0 0 128 128">
			<path
				:fill="!hover ? '#fff' : '#007acc'"
				class="duration-400"
				d="M22.67 47h99.67v73.67H22.67z"></path>
			<path
				:fill="!hover ? '#007acc' : '#fff'"
				class="duration-400"
