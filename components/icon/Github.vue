<template>
	<div
		class="relative w-fit p-2 border-#333 border-4 rounded-xl after:(absolute duration-400 content-[''] h-0 w-0 rounded-[100px] left-1/2 top-1/2 bg-#333 -z-100) after:hover:(w-full h-full top-0 left-0 rounded-md)">
		<svg
